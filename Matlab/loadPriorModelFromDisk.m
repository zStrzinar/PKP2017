...
switch type_colorspace,
    case Colorspace.hsv,
        a = coder.load('EM_parameters_hsv.mat');
    case Colorspace.lab,
        a = coder.load('EM_parameters_lab.mat');
    case Colorspace.rgb,
        a = coder.load('EM_parameters_rgb.mat');
    case Colorspace.ycrcb,
        a = coder.load('EM_parameters_ycrcb.mat');
    case Colorspace.ycrs,
        a = coder.load('EM_parameters_ycrs.mat');
    otherwise
